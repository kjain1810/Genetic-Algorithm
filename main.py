...
def submit_vector():
    ...
    # GET THE VALUE HERE
    best_vec = [
        -5.36468823256506331186578073315140747568722943394015209225834e-19,
        -1.48112099387616546233121377700391635054942562899071845095023e-12,
        -2.14468714202890214162882797637928555773778951931696212795941e-13,
        5.50859126215671315830087916239120402611684212956788542214781e-11,
        -1.49630808399548584893584364370025703572242292693772469647229e-10,
        -1.64864422528247248507024362841858830137976876274719106874045e-15,
        9.12977007134954067060227874489872409607450504803738411396807e-16,
        2.66457761341897641225225784600283418512844946235418319702148e-05,
        -1.91303734215514581313536020268362136675932561047375202178955e-06,
        -1.52980744794753375253096983445513790123015951394336298108101e-08,
        8.80788551104854461499241732278268554590106020896200789138675e-10,
...
def main():
    ...
    for i in range(50):
        print(init[i]["results"][0]/1e11, init[i]["results"][1]/1e11)
        for j in range(11):
            print(format(init[i]["vector"][j], '0.60g'))
    return
